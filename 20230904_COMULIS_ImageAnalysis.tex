...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\linewidth}
			...
			\only<5>{%
				\centering%
				\includegraphics[width=\imagewidth]{./images/foramen}%
				\sourcecite{Wolf2017}{Fig.~1}%
				}%
			\only<6>{%
				\centering%
				\animategraphics[loop,autoplay,width=\imagewidth]{24}{./movies/coder/coder-}{0}{133}%
...
\begin{frame}
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center) [shift={(0,-25pt)}]{%
			...
			\only<2>{\includegraphics[height=\imageheight]{./images/briseno}\sourcecite{Briseno-Marroquin2015}{Fig.~2}}%
...
\begin{frame}
	...
	\centering
	\only<1>{%
		\includegraphics[height=\imageheight]{./images/tooth045/Tooth045_ExtractedSlices}%
		}%
	\only<2>{%
		\includegraphics[width=\linewidth]{./images/tooth045/Tooth045_Briseno}%
		}%
\end{frame}
...
\begin{frame}
	...
	\centering
	\only<1>{%
		\includegraphics[height=\imageheight]{./images/foramen}%
		\sourcecite{Wolf2017}{Fig.~1}%
		}%
	\only<2>{%
		\animategraphics[palindrome,autoplay,height=\imageheight]{24}{./movies/tooth045/edt-axial/Tooth045_EDT_Axial_}{100}{199}%
		}%
	\only<3>{%
		\animategraphics[palindrome,autoplay,height=\imageheight]{24}{./movies/tooth045/edt-coronal/Tooth045_EDT_Coronal_}{123}{213}%
		}%
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Cichlids
		\item Preprint: \href{http://doi.org/krfn}{doi.org/krfn}\footcite{Haberthuer2023}
...
\begin{frame}[label=current]
	...
	\begin{columns}
		\begin{column}{0.49\linewidth}
			\begin{itemize}
				\item \cite{Mercader2023}
				\item Part of a bigger study
				\item Confirmation of results by \uct
			\end{{itemize}
		\end{column}
		\begin{column}{0.49\linewidth}
			\includegraphics[page=1,height=\imageheight]{./images/cox7a/Cell_Fig3}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\includegraphics<1>[height=\imageheight]{./images/cox7a/Overview}%
	\includegraphics<2>[height=\imageheight]{./images/cox7a/ko02_Cut}%
	\includegraphics<3>[height=\imageheight]{./images/cox7a/Histograms_Experiment}%
	\includegraphics<4>[height=\imageheight]{./images/cox7a/Volume_Boxplot}%
\end{frame}
