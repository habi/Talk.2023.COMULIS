...
\begin{frame}
	...
	\animategraphics[autoplay,loop,height=\imageheight,every=\everyframe]{24}{./movies/scan/projections/KP-TNIKWT02_240_projections_of_940_800_px_}{000}{313}
\end{frame}
...
\begin{frame}
	...
	\centering
	% Movie frames generated with https://github.com/habi/Lecture.Microtomography/blob/master/Notebooks/FromProjectionsToReconstructions.ipynb
	\animategraphics[autoplay,palindrome,height=\imageheight,every=\everyframe]{24}{./movies/scan/reconstructions/KP-TNIKWT02_240_reconstructions_of_556_800_px_}{000}{277}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.382\linewidth}
			\centering
			\includegraphics<1>[height=\imageheight]{./images/cox7a/Cell_Fig3}%
			\only<2>{%
